...
#include <poloka/wcsutils.h> // for WCSFromHeader
#include <poloka/gtransfo.h>
#include <poloka/fileutils.h>
#include <poloka/dimage.h> // for Kernel
#include <poloka/poly2.h>
#include <poloka/poly1.h> // used for non linearity of response fitting.
#include <poloka/polokaexception.h>
#include <poloka/datacards.h>
#include <poloka/polokaconf.h>
#include <poloka/fitsimage.h>
#include <poloka/sparsevect.h>
...
#include <poloka/astroutils.h> // IdentifyDeepField.

#include <poloka/nonlinmodel.h>
#include <poloka/imagepsf.h>
#include <poloka/analyticpsf.h>
	     ...
	     const string &ExternalCatalogName)
{
  ...
  if (!ExternalCatalogName.empty()) // both cases tested 
    { 
